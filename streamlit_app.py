...
gb.configure_grid_options(sortModel=[{"colId": "id", "sort": "des"}])

gb.configure_column(field="id", header_name="id",  suppressMenu=True, sortable=True, filter=False, hide=True)
